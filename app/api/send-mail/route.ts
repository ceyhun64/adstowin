...
export async function POST(req: Request): Promise<Response> {
  try {
    ...
    // Modern, Profesyonel HTML Template - AdsToWin
    const htmlTemplate = `
<!DOCTYPE html>
<html lang="tr">
<head>
  ...
  <title>AdsToWin - Yeni Mesaj</title>
</head>
...
<div style="background: linear-gradient(135deg, #1a2a6c 0%, #b21f1f 100%); padding: 15px 28px; text-align: center; position: relative;">
  ...
  <p style="margin: 8px 0 0 0; font-size: 14px; color: #ffffff; font-weight: 500; position: relative; z-index: 1;">
    Reklam Stratejileriyle Kazanan Tarafta Olun
  </p>
</div>

      <div style="padding: 48px 40px;">

        <div style="display: inline-flex; align-items: center; gap: 8px; background: linear-gradient(135deg, #1a2a6c 0%, #b21f1f 100%); color: white; padding: 10px 20px; border-radius: 50px; font-size: 13px; font-weight: 600; margin-bottom: 24px; box-shadow: 0 4px 12px rgba(26, 42, 108, 0.2);">
        ...
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); border: 2px solid #e3e3e3; border-radius: 12px; padding: 28px; margin-bottom: 32px; position: relative; overflow: hidden;">
          ...
          <div style="position: absolute; top: 0; right: 0; width: 80px; height: 80px; background: linear-gradient(135deg, rgba(26, 42, 108, 0.05) 0%, rgba(178, 31, 31, 0.05) 100%); border-radius: 0 0 0 100%;"></div>
          ...
          <div style="position: relative; z-index: 1;">
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px; padding-bottom: 16px; border-bottom: 2px solid #e3e3e3;">
              ...
              <strong style="font-size: 15px; color: #1a2a6c; font-weight: 600;">Mesaj İçeriği</strong>
            </div>
        ...
        <div style="background: linear-gradient(135deg, #fff9e6 0%, #fff5d9 100%); border-left: 4px solid #ffc107; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
          <p style="margin: 0; font-size: 14px; color: #5c4600; line-height: 1.6;">
            <strong>💡 Not:</strong> Bu mesaj otomatik olarak tarafınıza iletilmiştir. Lütfen en kısa sürede geri dönüş yapınız.
          </p>
        </div>

        <div style="text-align: center; margin-top: 32px;">
          <a href="mailto:contact@adstowin.com" style="display: inline-block; background: linear-gradient(135deg, #1a2a6c 0%, #b21f1f 100%); color: #ffffff; padding: 14px 32px; text-decoration: none; border-radius: 50px; font-weight: 600; font-size: 14px; box-shadow: 0 4px 15px rgba(26, 42, 108, 0.3); transition: all 0.3s;">
            Yanıtla
          </a>
        </div>
      </div>
      ...
      <div style="background: #f8f9fa; padding: 32px 40px; text-align: center; border-top: 1px solid #e9ecef;">
        ...
        <div style="margin-bottom: 20px;">
          <p style="margin: 0 0 12px 0; font-size: 16px; color: #222222; font-weight: 700;">
            AdsToWin Dijital Pazarlama
          </p>
          <p style="margin: 0 0 8px 0; font-size: 14px; color: #444444;">
            ✉️ <a href="mailto:contact@adstowin.com" style="color: #1a2a6c; text-decoration: none;">contact@adstowin.com</a>
          </p>
        </div>
        ...
        <p style="margin: 12px 0 0 0; font-size: 12px; color: #555555; line-height: 1.5;">
          ...
          © ${new Date().getFullYear()} AdsToWin. Tüm hakları saklıdır.
        </p>
      </div>
    ...
    await transporter.sendMail({
      from: `"AdsToWin" <${process.env.EMAIL_USER}>`,
      to: recipients.join(", "),
      subject,
      text: message,
      html: htmlTemplate,
      attachments: [
        {
          filename: "logotrans.png",
          path: "./public/logo/logotrans.png", // Buradaki dosya yolunu kendi logonuzla güncellemeyi unutmayın
          cid: "adstowin-logo",
